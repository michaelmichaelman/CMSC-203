 ...
 * Description: The FXMainPane class is the class that I did not touch. It provides the framework for the 
 * GUI panel and for all of the functionality that goes along with it. Methods from the CryptoManager class
 * are employed to build a user friendly and aesthetically pleasing experience in the form of a dialogue box.
 * Due: 10/27/2023
